 ...
 * @author Brent
 */
public class CharacterNameCheckHandler implements PacketHandler<Client> {
    ...
    public void handle(Client c, PacketReader r) {
        ...
        c.write(PacketCreator.getNameCheckResponse(name, Player.checkName(name, c.getWorld())));
    }
}
