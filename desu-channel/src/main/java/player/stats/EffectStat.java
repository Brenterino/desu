...
public enum EffectStat implements IntegerValue {
    ...
    // 
      ...
      SPEED_INFUSION(0x00400000, 2),
       ...
       // XXX wonder if there's stuff here, dont think so
     ...
     MANA_REFLECTION(0x00000040, 3),
        ...
        ECHO_OF_HERO(0x00008000, 3), // 79
          MESO_BONUS(0x00010000, 3), // 80
         GHOST_MORPH(0x00020000, 3), // 81
             BARRIER(0x00040000, 3), // v83?
    INVERSE_CONTROLS(0x00080000, 3, true), // v83?
...
INC_EFFECT_MP_POTION(0x04000000, 3), // v83?
    ...
    // XXX find out what 91 -> energy charge (?), 92 -> dash speed, 93 dash jump, 
    // 94 -> no idea, 
    // 95 -> d/c
